  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Luciani Heindrickson — Portfólio Cultural" },
      {
        ...
        content:
          "Escrita, memória e produção cultural. Portfólio institucional para editais de fomento à cultura.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Lora:ital,wght@0,400;0,500;1,400&family=Inter:wght@300;400;500;600&display=swap",
      },
    ],
  }),
