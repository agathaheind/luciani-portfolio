  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contribuição Cultural — Luciani Heindrickson" },
      {
        ...
        content: "Uma reflexão sobre a contribuição da autora à memória, literatura e cultura regional.",
      },
    ],
  }),
...
const pillars = [
  {
    ...
    text:
      "Cada projeto é também um arquivo: registrar histórias de vida, cadernos, fotografias e cartas é impedir que a cidade esqueça de si mesma.",
  },
  {
    kicker: "II",
    title: "Fortalecimento da literatura",
    text:
      "A publicação de coletâneas, a mediação de leituras e a formação de escritoras iniciantes ampliam a rede literária regional e a circulação de novos autores.",
  },
  {
    kicker: "III",
    title: "Valorização das mulheres",
    text:
      "Perspectivas femininas são o eixo da pesquisa e da escrita — mulheres da fronteira, mães, avós, professoras, poetas — narradoras, todas.",
  },
  {
    kicker: "IV",
    title: "Identidade regional",
    text:
      "A tríplice fronteira é território literário: sua paisagem, suas línguas e suas travessias compõem uma identidade cultural que precisa de espaço público.",
  },
  {
    kicker: "V",
    title: "Democratização da cultura",
    text:
      "Ações gratuitas, acessíveis e realizadas em espaços públicos garantem que a literatura chegue a quem, historicamente, esteve fora do circuito cultural formal.",
  },
];
